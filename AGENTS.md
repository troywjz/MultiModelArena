...
本项目从零构建一个多模型评测与共识报告工具。核心交付物是：用户配置若干 AI 模型后，运行程序，得到可视化网页报告，说明每个模型的优缺点、维度得分、适合的团队角色和形成结论的证据。

## 工作原则

- 先读 `README.md`、`ARCHITECTURE.md`、`docs/product/requirements.md`、`docs/plans/mvp-plan.md`，再改代码。
...
- 必须创建或更新必要的项目文件，例如 README、AGENTS.md、架构说明、运行说明和测试说明。
